...
const binaryAnalyzer_1 = require("./binaryAnalyzer");
(0, node_test_1.default)('pass', () => {
    const analyzer = new binaryAnalyzer_1.BinaryAnalyzer()
        ...
        .addGroup('d', new binaryAnalyzer_1.BinaryAnalyzer()
    ...
    node_assert_1.default.equal(isValid, true, "validation failed");
    node_assert_1.default.equal(data !== null, true, "data is null");
    node_assert_1.default.deepEqual(data, {
        a: 0x0001,
        a2: 0x0302,
        b: "obniz",
        c: [0x07, 0x08],
...
(0, node_test_1.default)('invalid', () => {
    const analyzer = new binaryAnalyzer_1.BinaryAnalyzer()
        .addTarget('a', [0, 1], 'UIntBE');
    const targetData = [0x00, 0x02];
    const isValid = analyzer.validate(targetData);
    const data = analyzer.getAllData(targetData); //validじゃない場合はnullが返ってくる
    node_assert_1.default.equal(isValid, false, "validation failed");
    node_assert_1.default.equal(data !== null, false, "data is null");
});
